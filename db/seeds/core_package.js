exports.seed = (knex) =>
  ...
  knex('packages')
    .del()
    .then(() => knex('packages').insert([
      {
        id: 'e3e591a3-5819-4c5f-8802-012bd0a0a03c',
        created_at: new Date(),
        name: 'core',
        ...
        code: JSON.stringify([
          ...
          [
            'def',
            'list?',
            ['fn', ['a'], ['.', 'Array', ['`', 'isArray'], 'a']],
          ],
          [
            'def',
            'contains?',
            ['fn', ['a', 'b'], ['.', 'a', ['`', 'hasOwnProperty'], 'b']],
          ],
          [
            'def',
            'get',
